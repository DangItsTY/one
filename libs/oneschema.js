var oneschema = {
  ...
  category:
    "string of a hierarchy to organize the note where each level|is|a|pipe",
  deadline: "timestamp when the note has a due date and time",
  tags: "string of hashtags #that#can#beused#tofilter#notes",
  priority:
    "number to be used to dynamically change the importance of a note and can at any time be manually set",
